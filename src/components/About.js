...
export const About = () => {
  const content = {
    heading: 'About Me',
    para1:
      "I'm a 21-year-old student at St. Xavier's College (Autonomous), Kolkata currently pursuing Masters in Computer Science. During my internships and studies, I've created some projects with great ui written in code that is functional and maintainable.",
    para2:
        ...
        <Zoom in={true} timeout={400}>
          <div className='icons about-icons hide-sm'>
            ...
            <a
              ...
              rel='noopener noreferrer'
            >
              <i className='fab fa-dev' title="soumyadey's DEV.to Profile"></i>
            </a>
          </div>
        </Zoom>
      </div>
